...
<script>
    ...
    function deleteProcedure(object){
        ...
        if (result.isConfirmed) {
            var settings = {
                "url": "./api/vendor/delete.php?id="+id,
                "method": "get",
            };
    ...
    function updateProcedure(object){
        ...
        var settings = {
            "url": "./api/vendor/update.php?id="+id,
            "method": "POST",
            "timeout": 0,
            "headers": {
	...
	<div class="row">
		<div class="col">
			<div class="section_title_container text-center">
				<h2 class="section_title">Vendor</h2>
			</div>
		</div>
...
<div class="tabset container">
  ...
  <label for="tab1">Add a New Vendor</label>
  <!-- Tab 2 -->
  <input type="radio" name="tabset" id="tab2" aria-controls="rauchbier">
  <label for="tab2">Store Vendors</label>

  <div class="tab-panels">
    <section id="marzen" class="tab-panel">
        <form action="./api/vendor/create.php" method="post">
            <div class="container">
                <table class="table table-bordered">
                    <tr>
                        <th colspan="4">Insert Vendor</th>
                    </tr>
                    <tr>
                        <td>Vendor Name</td>
                        <td><input required type="text" class="form-control" name="vendor_name"></td>
                        <td>Vendor Contact</td>
                        <td><input type="text" class="form-control" name="vendor_contact"></td>
                    </tr>
                    <tr>
