...
$activity="Sending Daily Report";
    $csvData = [
     ...
     CURLOPT_URL => $_SERVER['SERVER_NAME'].'/south-lane/api/billing/read-shop-cron.php',
    ...
    $csvData[$rowIndex+1][$colIndex++]=$value->cost;
    $csvData[$rowIndex+1][$colIndex++]=$value->total_amount - $value->cost;
...
<td class="total_amount">'.$totalTotalCost.'</td>
<td class="total_amount">'.$totalTotalAmount-$totalTotalCost.'</td>
...
//  $date='2022-04-04';
    ...
    $filename = './reports/Shop Daily Report - Dated '.$date.'.csv';
