...
if (isset($_GET['contact_number'])) {
    $urlToHit=$_SERVER['SERVER_NAME'].'/south-lane/api/billing/read-90.php?contact_number='.urlencode($_GET['contact_number']);
    if (isset($_GET['pending']) && $_GET['pending']=="true") {
        $urlToHit.="&pending=true";
    }
}else{
    $urlToHit=$_SERVER['SERVER_NAME'].'/south-lane/api/billing/read-90.php';
    if (isset($_GET['pending']) && $_GET['pending']=="true") {
        $urlToHit.="?pending=true";
    }
}
