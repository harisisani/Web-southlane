   ...
   <body id="page-top" data-spy="scroll" data-target=".navbar-custom">
	...
	<section style="padding: 120px 0px 0px 0px;" id="main" class="home-section promotion container">
		  ...
		  <div style="margin-bottom: 50px;" class="section-heading">
			 ...
			 <div class="hr"></div> -->
			 <div class="col-md-12 fadeInRight" data-wow-delay="0.2s"></div>
				<div class="section_title_container text-center">
					<h2 class="section_title">Get 50% OFF ON GROOMING SERVICES</h2>
  ...
  <div class="col-xs-12">
    <section id="count-up-section" class="count-up-section">
      ...
      <!-- end container -->
			 ...
			 <div id="promotion-image" class="col-md-6 fadeInRight" data-wow-delay="0.2s">
				<div style="width:100%;height:100%; margin-bottom:50px;" class="img-wrapper">
					<img style="width: 100%;" src="./img/promotions/1.jpg" alt="">
				</div>
				</p>
			</div>
			<div id="promotion-form" class="col-md-6 fadeInRight" data-wow-delay="0.2s">
			<div class="section_title_container text-center">
					<h3 class="section_title">Get Now!</h3>
					<div class="hr"></div>
					<br>
					<p>Fields with * are required</p>
				</div>
						...
						<div class="login100-form validate-form">
							...
							<div class="container" style="width: 100%;float: right;">
								<div class="wrap-login100-form-btn">
									...
									<but class="login100-form-btn" onclick="getVoucher();">
										Get Voucher <i class="fa fa-arrow-right" aria-hidden="true"></i>
									</but>
								</div>
							</div>
						</div>
...
<!--===============================================================================================-->
	...
	<!-- Section Contact -->
	<section id="contact" style="margin-top:50px;padding: 0" class="home-section">
...
<script>
  ...
  return phoneNumber;
	...
	$('#promotion-image').click(function(event) {
		$('html, body').animate({
			scrollTop: $("#promotion-form").offset().top
		}, 2000);
	});
...
(function($) {
  ...
  var dt1 = "04/30/" + dt.getFullYear() + " 00:00:01 am +0000";
