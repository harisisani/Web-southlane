...
if (isset($_GET['contact_number'])) {
    $urlToHit=$_SERVER['SERVER_NAME'].'/south-lane/api/billing/read-shop.php?contact_number='.urlencode($_GET['contact_number']);
    if (isset($_GET['pending']) && $_GET['pending']=="true") {
        $urlToHit.="&pending=true";
    }
}else{
    $urlToHit=$_SERVER['SERVER_NAME'].'/south-lane/api/billing/read-shop.php';
    if (isset($_GET['pending']) && $_GET['pending']=="true") {
        $urlToHit.="?pending=true";
    }
}
            ...
            <div class="row">
                <div class="col">
                    <div class="section_title_container text-center">
                        <h2 class="section_title">View Store Billings</h2>
                    </div>
                </div>
            </div>
        </div>
        <div class="container" style="margin-top:50px; overflow-x:scroll;">
            <table id="patientsTable" class="table table-bordered">
                <thead>
                    ...
                    <tr style="background:#F60017; color:white;">
                        ...
                        <th style="vertical-align: middle;">Profit Earned</th>
            ...
            <tbody>
                ...
                <tr class="template">
                    ...
                    <td class="total_cost"><?=$value->cost?></td>
                    <td class="total_profit"><?=($value->total_amount - $value->cost)?></td>
