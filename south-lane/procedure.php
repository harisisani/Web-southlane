...
<script>
    ...
    function deleteProcedure(object){
        ...
        if (result.isConfirmed) {
            var settings = {
                "url": "./api/procedure/delete.php?id="+id,
                "method": "get",
            };
    ...
    function updateProcedure(object){
        ...
        var settings = {
            "url": "./api/procedure/update.php?id="+id,
            "method": "POST",
            "timeout": 0,
            "headers": {
	...
	<div class="row">
		<div class="col">
			<div class="section_title_container text-center">
				<h2 class="section_title">Procedures</h2>
			</div>
		</div>
...
<div class="tabset container">
  ...
  <label for="tab1">Add a Procedure</label>
  <!-- Tab 2 -->
  <input type="radio" name="tabset" id="tab2" aria-controls="rauchbier">
  <label for="tab2">Procedures</label>

  <div class="tab-panels">
    <section id="marzen" class="tab-panel">
        <form action="./api/procedure/create.php" method="post">
            <div class="container">
                <table class="table table-bordered">
                    <tr>
                        <th colspan="4">Insert Procedure</th>
                    </tr>
                    <tr>
            ...
            <table id="patientsTable" class="table table-bordered">
                ...
                <tbody>
                    ...
                    <tr class="template">
                        ...
                        <td class="procedureId"><?=$value->procedure_id?></td>
                        <td class="procedureName"><?=$value->procedure_name?></td>
                        <td class="procedureAmount"><?=$value->procedure_amount?></td>
                    </tr>
                    <?php }?>
                </tbody>
            </table>
